...
local dynamic        = require("scripts.ErnMMUI.render.dynamic")
local interfaces     = require('openmw.interfaces')
local myui           = require("scripts.ErnMMUI.pcp.myui")
...
return {
    ...
    ballTexture = ui.texture {
        path = "textures\\ErnMMUI\\circle-full.png"
    },
    bufferPinTexture = ui.texture {
        path = "textures\\ErnMMUI\\circle.png"
    },
    shadeTexture = ui.texture {
        path = "textures\\ErnMMUI\\circle-ball-shade-3.png"
    },
    toolTextures = {
        [const.ToolClass.CALCINATOR] = ui.texture {
            path = "textures\\ErnMMUI\\group.png"
        },
        [const.ToolClass.ALEMBIC] = ui.texture {
            path = "textures\\ErnMMUI\\plus.png"
        },
        [const.ToolClass.RETORT] = ui.texture {
            path = "textures\\ErnMMUI\\triangle.png"
        }
    },
